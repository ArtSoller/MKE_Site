...
<html lang="ru">
    ...
    <div class="container-fluid">
        <div class="row row-cols-12">
            <div class="col-12">
                <p>Приветствуем Вас на сайте, посвященном построению сплайнов и решению дифференциальных уравнений методом конечных элементов! </p>
                <p>Воспользоваться предлагаемыми услугами Вы можете нажав на "Сплайн" или "МКЭ" в шапке нашего сайта, а затем выбрав необходимый Вам вариант решения. Кроме того, Вы можете прочитать информацию о разработчиках сайта, которая находится во вкладке "О нас".</p>
                <p>Итак, перед началом работы рекомендуем ознакомиться с теорией по указанным выше темам. (+ТЕОРИЯ) </p>
            </div>
        </div>
    </div>
    </main>   
